...
from sabre.tea import make_baseline_tea, solve_biomethane_msp
...
fig.savefig(OUT / "fig_biostimulant_sensitivity.pdf", bbox_inches="tight")
...
print(OUT / "fig_biostimulant_sensitivity.pdf")